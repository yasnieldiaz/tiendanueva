...
const translations = {
  pl: {
    ...
    subtitle: "Informacje o wysylce i zwrotach",
    shippingMethods: "Metody dostawy",
    shippingDescription:
      "Oferujemy szybka i bezpieczna dostawe na terenie calej Unii Europejskiej.",
    freeShipping: "Darmowa dostawa!",
    freeShippingDesc: "Przy zamowieniach powyzej 5000 zl",
    processingTime: "Czas realizacji",
    processingDescription:
      "Zamowienia sa przetwarzane w ciagu 1-3 dni roboczych. Po wyslaniu otrzymasz e-mail z numerem sledzenia przesylki.",
    businessDays: "dni robocze",
    orderPreparation: "Kompletowanie zamowienia",
    hours: "godzin",
    deliveryTime: "Czas dostawy",
    tracking: "tracking",
    shipmentTracking: "Sledzenie przesylki",
    outOfStockNote:
      "W przypadku braku towaru w magazynie skontaktujemy sie z Toba w celu ustalenia terminu realizacji.",
    deliveryCountries: "Obszar dostawy",
    deliveryCountriesDescription:
      "Realizujemy dostawy na terenie calej Unii Europejskiej:",
    countriesList: [
      "Polska",
      "Niemcy",
      "Czechy",
    ...
    outsideEUNote:
      "Dla dostaw poza UE prosimy o kontakt w celu ustalenia kosztow wysylki.",
    returnPolicy: "Zwroty",
    returnDays: "dni na zwrot",
    withoutReason: "bez podania przyczyny",
    returnPolicyDescription:
      "Zgodnie z Dyrektywa 2011/83/UE masz prawo odstapic od umowy w ciagu 14 dni od daty otrzymania towaru bez podawania przyczyny.",
    returnProcess: "Jak dokonac zwrotu?",
    returnSteps: [
      {
        title: "Wypelnij formularz",
        description:
          "Wypelnij formularz zwrotu na naszej stronie lub wyslij e-mail",
      },
      {
        title: "Zapakuj towar",
        description:
      ...
      {
        title: "Wyslij przesylke",
        description: "Wyslij paczke na nasz adres (koszty pokrywa kupujacy)",
      },
      {
        title: "Otrzymaj zwrot",
        description: "Po otrzymaniu towaru zwrot pieniedzy w ciagu 14 dni",
      },
    ],
    importantNotes: "Wazne informacje",
    notes: [
      "Towar musi byc nienaruszony i w oryginalnym opakowaniu",
      "Dolacz dowod zakupu (paragon lub fakture)",
      "Koszty zwrotu pokrywa kupujacy",
      "Prawo zwrotu nie dotyczy produktow wykonanych na zamowienie",
      "Zwrot dotyczy tylko konsumentow (osob fizycznych)",
    ],
    contactUs: "Masz pytania dotyczace dostawy?",
    contactDescription: "Nasz zespol obslugi klienta chetnie pomoze.",
    inpostName: "InPost Paczkomaty",
    inpostDesc: "Odbior w paczkomacie 24/7",
    glsName: "GLS Kurier",
